...
class InterfuserAgent(autonomous_agent.AutonomousAgent):
    ...
    def tick(self, input_data):
        ...
        processed_images = self.data_processor.process_rgb_batch(images_to_process)
    ...
    def destroy(self):
        ...
        if hasattr(self, 'data_processor'):
            ...
            if hasattr(self, 'save_path') and self.save_path:
                stats_file = self.save_path / 'processor_stats.json'
                self.data_processor.save_stats(str(stats_file))
