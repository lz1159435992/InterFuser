...
echo "褰撳墠 Python 鐗堟湰: ${CURRENT_PYTHON}"
...
# 馃敟 Determine frame rate based on NATIVE_ENHANCE 馃敟
FRAME_RATE=20
...
# 馃敟 淇敼锛氶粯璁ゅ湪鑴氭湰鎰忓閫€鍑烘椂鍏抽棴 CARLA 杩涚▼ 馃敟
...
# 馃敟 Create a custom leaderboard evaluator wrapper to set frame rate 馃敟
