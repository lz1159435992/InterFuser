...
def main():
    ...
    parser.add_argument(
        "--kitti-root",
        default=os.path.join(PROJECT_ROOT, "data", "kitti"),
    ...
    parser.add_argument(
        "--output-root",
        default=os.path.join(PROJECT_ROOT, "data", "kitti", "combo"),
    ...
    parser.add_argument(
        "--process-method-root",
        default=os.path.join(PROJECT_ROOT, "third_party", "process_mothod"),
    )

    # SRGAN
    parser.add_argument(
        "--srgan-model-path",
        default=os.path.join(PROJECT_ROOT, "third_party", "process_mothod", "SRGAN", "results", "checkpoint_srgan.pth"),
    )
    ...
    parser.add_argument(
        "--rife-model-dir",
        default=os.path.join(PROJECT_ROOT, "third_party", "process_mothod", "ECCV2022-RIFE", "train_log"),
    )
