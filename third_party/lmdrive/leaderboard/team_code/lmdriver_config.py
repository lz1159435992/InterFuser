...
class GlobalConfig:
    ...
    preception_model_ckpt = 'vision-encoder-r50.pth.tar'
    lmdrive_ckpt = 'llava-v1.5-checkpoint.pth'
    ...
    # Whether to enable external sensor data processor during evaluation
    use_data_processor = False
