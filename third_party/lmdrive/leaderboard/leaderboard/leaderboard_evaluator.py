...
class LeaderboardEvaluator(object):
    ...
    def __init__(self, args, statistics_manager):
        ...
        if os.environ.get('IGNORE_CARLA_VERSION_CHECK', '0') != '1':
    ...
    def _prepare_ego_vehicles(self, ego_vehicles, wait_for_ego_vehicles=False):
        ...
        # sync state
        tick_timeout = float(os.environ.get("CARLA_TICK_TIMEOUT", "10.0"))
        CarlaDataProvider.get_world().tick(tick_timeout)
    ...
    def _load_and_wait_for_world(self, args, town, ego_vehicles=None):
        ...
        if CarlaDataProvider.is_sync_mode():
            tick_timeout = float(os.environ.get("CARLA_TICK_TIMEOUT", str(self.client_timeout)))
            self.world.tick(tick_timeout)
        else:
