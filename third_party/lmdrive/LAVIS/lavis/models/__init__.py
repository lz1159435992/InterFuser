...
# NOTE: Importing all model definitions pulls in many optional dependencies (e.g., spacy, diffusers).
# For LMDrive evaluation we only need the drive model registered in the registry.
if os.environ.get("LAVIS_IMPORT_ALL", "0") == "1":
    ...
    from lavis.models.drive_models.drive import Blip2VicunaDrive
    __all__ = ["load_model", "BaseModel", "Blip2VicunaDrive"]
